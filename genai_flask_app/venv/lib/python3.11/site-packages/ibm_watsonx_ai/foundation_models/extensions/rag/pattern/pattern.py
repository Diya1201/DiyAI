...
from ibm_watsonx_ai.foundation_models.extensions.rag.pattern.default_inference_service_chroma import (
    default_inference_service as default_inference_service_chroma,
)
...
class RAGPattern:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        :param input_data_references: List of DataConnection instances from which knowledge base will be recreated
