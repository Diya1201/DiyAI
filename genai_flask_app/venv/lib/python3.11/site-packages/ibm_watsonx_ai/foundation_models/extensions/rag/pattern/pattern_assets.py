...
class RAGPatternService(BaseRAGPatternService):
    ...
    def __init__(
        ...
        self._source_file: tempfile._TemporaryFileWrapper | None
    ...
    def _populate_default_params(
        ...
        Method populates in template `default_inference_service` the placeholders that starts with `REPLACE_THIS_CODE_WITH_` using default_params.
        ...
        replace_data = dict(
            ...
            **credentials_params,
            **api_client_params,
            REPLACE_THIS_CODE_WITH_VECTOR_STORE={
        ...
        with tempfile.NamedTemporaryFile(
            suffix="default_inference_service.py", delete=False
        ) as tmp_file:
            tmp_file.write(code.encode())

        self._source_file = tmp_file
    ...
    def pretty_print(self, insert_to_cell: bool = False) -> None:
        ...
        # default params are populated in init
        code = inspect.getsource(self.ai_service)
